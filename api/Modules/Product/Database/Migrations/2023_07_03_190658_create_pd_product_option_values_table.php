...
class CreatePdProductOptionValuesTable extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
     */
    public function up() {
        Schema::create('pd__product_option_values', function(Blueprint $table) {
            $table->increments('id');
    ...
    public function down() {
        Schema::dropIfExists('pd__product_option_values');
    }
}
