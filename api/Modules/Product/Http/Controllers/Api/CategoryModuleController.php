...
use Modules\Product\Repositories\CategoryModuleDescRepository;
use Modules\Product\Repositories\CategoryModuleRepository;
 ...
 * Date: 2022-11-28
 */
class CategoryModuleController extends ApiBaseModuleController {
    use ModuleRequestsTrait, ModuleResultModelTrait;
    /**
     * @var \Modules\Product\Repositories\CategoryModuleDescRepository
     */
    protected $category_module_desc_repository;
    ...
    public function __construct(Request $request,
                                ...
                                CategoryModuleRepository $category_module_repository,
                                CategoryModuleDescRepository $category_module_desc_repository,
        ...
        $this->model_repository = $category_module_repository;
        $this->category_module_desc_repository = $category_module_desc_repository;
    ...
    private function getResultModel($model) {
        ...
        // Preview
        $model->preview_url = config('app.url') . "/module/preview?pdcid={$model->id}&ly={$model->layout}";
    ...
    /**
     * @OA\Get(
     *   path="/backend/pd_category_modules",
     *   summary="Get Product Category Modules",
     *   operationId="getPdCategoryModules",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     ...
     *   @OA\Parameter(name="data", in="query", description="{embed:Optional get related fields, fields: Optional get optional fields} | Syntax: embed=PROPERTYNAME or embed=PROPERTYNAME.CHILDPROPERTYNAME | fields=PROPERTYNAME1,PROPERTYNAME2", example="%7B%22category_id%22%3A0%7D"),
    ...
    public function index() {
        try {
            ...
            $fields = ['*', \DB::raw("(select `cf_data` from `pg__modules` where `code` = `pd__category_modules`.`code`) as cf_data")];
    ...
    /**
     * @OA\Get(
     *   path="/backend/pd_category_modules/{id}",
     *   summary="Get Product Category Module",
     *   operationId="getPdCategoryModule",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Product Category Module Id", example="1"),
     ...
     * @OA\Post(
     *   path="/backend/pd_category_modules",
     *   summary="Create Product Category Module",
     *   operationId="createPdCategoryModule",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\RequestBody(
     *     @OA\JsonContent(
    ...
    public function store() {
        try {
            $input = $this->request->only(['category_id', 'name', 'code', 'title', 'sub_title', 'short_description', 'description', 'is_overwrite', 'layout', 'tile', 'image', 'attach', 'menu_text', 'btn_text', 'btn_link', 'sort_order']);
     ...
     * @OA\Put(
     *   path="/backend/pd_category_modules/{id}",
     *   summary="Update Product Category Module",
     *   operationId="updatePdCategoryModule",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Product Category Module Id", example="1"),
     *   @OA\RequestBody(
     ...
     * @OA\Patch(
     *   path="/backend/pd_category_modules/{id}",
     *   summary="Update Product Category Module Partial",
     *   operationId="UpdatePdCategoryModulePartial",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Product Category Module Id", example="1"),
     *   @OA\RequestBody(
     ...
     * @OA\Delete(
     *   path="/backend/pd_category_modules/{id}",
     *   summary="Delete Product Category Module",
     *   operationId="deletePdCategoryModule",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Product Category Module Id", example=1),
     *   @OA\Response(response=200, description="Success", @OA\JsonContent()),
    ...
    /**
     * @OA\Post(
     *   path="/backend/pd_category_modules/{id}/copy",
     *   summary="Copy Product Category Module",
     *   operationId="copyPdCategoryModule",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\Response(response=200, description="Success", @OA\JsonContent()),
     *   @OA\Response(response=400, description="Invalid request params"),
    ...
    public function copy($id) {
        try {
            ...
            $results = $this->category_module_desc_repository->getModel()->where('id', $id)->get();
            foreach ($results as $result) {
                $this->category_module_desc_repository->create(array_merge($result->toArray(), ['id' => $model->id, 'lang' => $result->lang]));
    ...
    /**
     * @OA\Post(
     *   path="/backend/pd_category_modules/{id}/description",
     *   summary="Update Product Category Module Description",
     *   operationId="updatePdCategoryModuleDescription",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
    ...
    public function description($id) {
        try {
            ...
            if ($lang == 'vi') {
                ...
                $modelDesc = $this->category_module_desc_repository->findByAttributes(['id' => $id, 'lang' => $lang]);
                if (!$modelDesc) {
                    $modelDesc = $this->category_module_desc_repository->create(array_merge($input, ['id' => $id, 'lang' => $lang]));
                } else {
                    $modelDesc = $this->category_module_desc_repository->update($modelDesc, $input);
                }
                $translates = $model->translates ? $model->translates : [];
                $translates[] = $lang;
                $translates = array_unique($translates);
    ...
    /**
     * @OA\Post(
     *   path="/backend/pd_category_modules/{id}/images",
     *   summary="Update Product Category Module",
     *   operationId="updatePdCategoryModuleImages",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Product Category Module Id", example="1"),
     *   @OA\RequestBody(
    ...
    /**
     * @OA\Post(
     *   path="/backend/pd_category_modules_sort_order",
     *   summary="Update Product Category Module Sort Order",
     *   operationId="updatePdCategoryModuleSortOrder",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Product Category Module Id", example="1"),
     *   @OA\RequestBody(
    ...
    /**
     * @OA\Post(
     *   path="/backend/pd_category_modules_modules",
     *   summary="Clone Product Category Module From Modules",
     *   operationId="clonePdCategoryModuleFromModules",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\RequestBody(
     *     @OA\JsonContent(
    ...
    public function cloneModules() {
        try {
            $input = $this->request->only(['category_id']);
            // Check Valid
            $validatorErrors = $this->getValidator($input, ['category_id' => 'required|integer']);
            if (!empty($validatorErrors)) return $this->respondWithError($validatorErrors);
            ...
            $temp = $this->model_repository->getModel()->selectRaw('max(sort_order) as sort_order')->where('category_id', $input['category_id'])->first();
            ...
            foreach ($modules as $module) {
                ...
                foreach ($module->descs as $desc) {
                    $this->category_module_desc_repository->create(array_merge($desc->toArray(), ['id' => $model->id]));
                }
                $models[] = $model;
            }
    ...
    /**
     * @OA\Post(
     *   path="/backend/pd_category_modules_patterns",
     *   summary="Clone Product Category Module From Patterns",
     *   operationId="clonePdCategoryModuleFromPatterns",
     *   tags={"BackendPdCategoryModules"},
     *   security={{"bearer":{}}},
     *   @OA\RequestBody(
     *     @OA\JsonContent(
