...
class ProductModule extends CoreModel {
     ...
     * @var string
     */
    protected $table = 'pd__product_modules';
     ...
     * @var array
     */
    protected $fillable = ['product_id', 'module_id', 'translates', 'name', 'code', 'title', 'sub_title', 'short_description', 'description', 'table_contents', 'table_images', 'properties', 'is_overwrite', 'layout', 'tile', 'image', 'attach', 'menu_text', 'btn_text', 'btn_link', 'sort_order', 'status'];
    ...
    public function descs() {
        return $this->hasMany('\Modules\Product\Entities\ProductModuleDesc', 'id', 'id');
    }
