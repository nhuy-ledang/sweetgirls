...
use Modules\User\Repositories\LeadSourceRepository;
 ...
 * Date: 2021-10-06
 */
class LeadSourceController extends ApiBaseModuleController {
    protected $maximumLimit = 20;

    public function __construct(Request $request,
                                LeadSourceRepository $lead_source_repository) {
        $this->model_repository = $lead_source_repository;
    ...
    /**
     * @OA\Get(
     *   path="/backend/lead_source_all",
     *   summary="Get Lead Source All",
     *   operationId="getLeadSourceAll",
     *   tags={"BackendLeadSources"},
     *   security={{"bearer":{}}},
     ...
     *     )
     *   ),
     *   @OA\Parameter(name="id", description="Lead Source Id", in="path", example=1),
     *   @OA\Response(response=200, description="Success", @OA\JsonContent()),
     *   @OA\Response(response=400, description="Invalid request params"),
     *   @OA\Response(response=401, description="Caller is not authenticated"),
     *   @OA\Response(response=404, description="Resource not found"),
