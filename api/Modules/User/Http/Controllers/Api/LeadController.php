...
use Modules\User\Repositories\LeadRepository;
 ...
 * Date: 2021-10-01
 */
class LeadController extends ApiBaseModuleController {
    protected $maximumLimit = 20;

    public function __construct(Request $request,
                                LeadRepository $lead_repository) {
        $this->model_repository = $lead_repository;
    ...
    /**
     * @OA\Get(
     *   path="/backend/lead_all",
     *   summary="Get Lead All",
     *   operationId="getLeadAll",
     *   tags={"BackendLeads"},
     *   security={{"bearer":{}}},
     ...
     *     )
     *   ),
     *   @OA\Parameter(name="id", description="Lead Id", in="path", example=1),
     *   @OA\Response(response=200, description="Success", @OA\JsonContent()),
     *   @OA\Response(response=400, description="Invalid request params"),
     *   @OA\Response(response=401, description="Caller is not authenticated"),
     *   @OA\Response(response=404, description="Resource not found"),
