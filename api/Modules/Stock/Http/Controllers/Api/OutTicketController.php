...
/**
 * Class OutTicketController
 *
 * @package Modules\Stock\Http\Controllers\Api
 * @author Huy Dang <huydang1920@gmail.com>
 * Date: 2023-05-03
 */
class OutTicketController extends TicketController {
    ...
    /**
     * @OA\Get(
     *   path="/backend/sto_out_tickets",
     *   summary="Get Out Tickets",
     *   operationId="stoGetOutTickets",
     *   tags={"BackendStoOutTickets"},
     *   security={{"bearer":{}}},
     ...
     * @OA\Post(
     *   path="/backend/sto_out_tickets",
     *   summary="Create Out Ticket",
     *   operationId="stoCreateOutTicket",
     *   tags={"BackendStoOutTickets"},
     *   security={{"bearer":{}}},
     *   @OA\RequestBody(
     *     @OA\JsonContent(
    ...
    public function store() {
        /*try {
            ...
            $input = $this->request->only(['stock_id', 'out_type', 'out_customer_id', 'out_stock_id', 'date', 'staff_id', 'storekeeper_id', 'accountant_id', 'reason', 'note']);
            // Check valid
...
//            $input['owner_id'] = $this->auth->id;
    ...
    /**
     * @OA\Put(
     *   path="/backend/sto_out_tickets/{id}",
    ...
    public function update($id) {
        /*try {
            ...
            $input = $this->request->only(['stock_id', 'out_type', 'out_supplier_id', 'out_stock_id', 'date', 'staff_id', 'storekeeper_id', 'accountant_id', 'reason', 'note']);
            // Check valid
    ...
    /**
     * @OA\Post(
     *   path="/backend/sto_out_tickets/{id}/status",
    ...
    public function status($id) {
        try {
            ...
            if ($input['status'] == STO_TICKET_SS_COMPLETED) {
                ...
                // Handle shipping
                if ($sto_request->platform == 'website' && $sto_request->invoice_id) {
                    app('\Modules\Order\Http\Controllers\Api\OrderController')->createShipping($sto_request->invoice_id);
                }
                $sto_request->shipping_status = STO_SHIPPING_SS_WAIT_OUT;
            } else {
    ...
    /**
     * @OA\Get(
     *   path="/backend/sto_out_tickets_products",
