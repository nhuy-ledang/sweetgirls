...
class CreateBusImportsTable extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function down() {
        Schema::dropIfExists('bus__imports');
    }
}
