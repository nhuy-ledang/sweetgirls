 ...
 * Date: 2023-02-04
 */
class SupplierCategoryController extends ApiBaseModuleController {
    protected $maximumLimit = 20;

    public function __construct(Request $request,
                                SupplierCategoryRepository $supplier_category_repository) {
        $this->model_repository = $supplier_category_repository;
    ...
    /**
     * @OA\Get(
     *   path="/backend/sup_categories_all",
     *   summary="Get Supplier Categories All",
     *   operationId="getSupplierCategoriesAll",
     *   tags={"BackendSupCategories"},
     *   security={{"bearer":{}}},
    ...
    /**
     * @OA\Get(
     *   path="/backend/sup_categories",
     *   summary="Get Supplier Categories",
     *   operationId="getSupplierCategories",
     *   tags={"BackendSupCategories"},
     *   security={{"bearer":{}}},
     ...
     *   operationId="createSupplierCategory",
     *   tags={"BackendSupCategories"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Supplier Category Id", example=1),
     *   @OA\RequestBody(
     *     @OA\JsonContent(
    ...
    /**
     * @OA\Post(
     *   path="/backend/sup_categories/{id}",
     *   summary="Update Supplier Category",
     *   operationId="updateSupplierCategory",
     *   tags={"BackendSupCategories"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Supplier Category Id", example=1),
     *   @OA\RequestBody(
     ...
     *   operationId="deleteSupplierCategory",
     *   tags={"BackendSupCategories"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Supplier Category Id", example=1),
     *   @OA\Response(response=200, description="Success", @OA\JsonContent()),
