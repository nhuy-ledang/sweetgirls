...
use Modules\Business\Repositories\PolicyGroupRepository;

/**
 * Class PolicyGroupController
 *
 * @package Modules\Business\Http\Controllers\Api
 * @author Huy Dang <huydang1920@gmail.com>
 * Date: 2022-04-16
 */
class PolicyGroupController extends ApiBaseModuleController {
    public function __construct(Request $request,
                                PolicyGroupRepository $group_repository) {
    ...
    /**
     * @OA\Get(
     *   path="/backend/bus_policy_groups_all",
     *   summary="Get Policy Groups All",
     *   operationId="getPolicyGroupsAll",
     *   tags={"BackendBusPolicyGroups"},
     *   security={{"bearer":{}}},
    ...
    /**
     * @OA\Get(
     *   path="/backend/bus_policy_groups",
    ...
    /**
     * @OA\Put(
     *   path="/backend/bus_policy_groups/{id}",
     *   summary="Update Policy Group",
     *   operationId="updatePolicyGroup",
     *   tags={"BackendBusPolicyGroups"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Policy Group Id", example=1),
     *   @OA\RequestBody(
     *     @OA\JsonContent(
     *       @OA\Property(property="name", type="string", example=""),
     *       @OA\Property(property="description", type="string", example=""),
