 ...
 * Date: 2023-04-06
 */
class MyServiceController extends OutProductController {
    /**
     * @var string
     */
    protected $prd_type = PROD_TYPE_MY_SERVICE;
    ...
    /**
     * @OA\Get(
     *   path="/backend/bus_my_services",
     *   summary="Get My Services",
     *   operationId="busGetMyServices",
     *   tags={"BackendBusMyServices"},
     *   security={{"bearer":{}}},
    ...
    /**
     * @OA\Get(
     *   path="/backend/bus_my_services/{id}",
     *   summary="Get a My Service",
     *   operationId="busGetMyService",
     *   tags={"BackendBusMyServices"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="My Service Id", example=1),
    ...
    /**
     * @OA\Post(
     *   path="/backend/bus_my_services_products",
     *   summary="Create My Service Product",
     *   operationId="busCreateMyServiceProduct",
     ...
     * @OA\Post(
     *   path="/backend/bus_my_services",
     *   summary="Create My Service",
     *   operationId="busCreateMyService",
     *   tags={"BackendBusMyServices"},
     *   security={{"bearer":{}}},
     *   @OA\RequestBody(
     *     @OA\JsonContent(
     ...
     *   operationId="busUpdateMyService",
     *   tags={"BackendBusMyServices"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="My Service Id", example=1),
     *   @OA\RequestBody(
     ...
     * @OA\Patch(
     *   path="/backend/bus_my_services/{id}",
     *   summary="Update My Service Partial",
     *   operationId="busUpdateMyServicePartial",
     *   tags={"BackendBusMyServices"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="My Service Id", example=1),
     *   @OA\RequestBody(
     ...
     *   operationId="busDeleteMyService",
     *   tags={"BackendBusMyServices"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="My Service Id", example=1),
     *   @OA\Response(response=200, description="Success", @OA\JsonContent()),
