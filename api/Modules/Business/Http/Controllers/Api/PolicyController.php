...
use Modules\Business\Repositories\PolicyRepository;
 ...
 * Date: 2022-04-16
 */
class PolicyController extends ApiBaseModuleController {
    public function __construct(Request $request,
                                PolicyRepository $policy_repository) {
        $this->model_repository = $policy_repository;
    ...
    protected function rulesForCreate() {
        return [
            'name' => 'required',
            'code' => 'required|unique:bus__policies,code',
    ...
    protected function rulesForUpdate($id) {
        return [
            'name' => 'required',
            'code' => 'required|unique:bus__policies,code,' . $id,
            'type' => 'required|in:P,F',
        ];
    }
    ...
    /**
     * @OA\Get(
     *   path="/backend/bus_policies_all",
     *   summary="GetOrderPolicyAll",
     *   operationId="GetOrderPolicyAll",
     *   tags={"BackendBusPolicies"},
     *   security={{"bearer":{}}},
    ...
    /**
     * @OA\Get(
     *   path="/backend/bus_policies",
     *   summary="Get Order Categories",
     *   operationId="getOrderCategories",
     *   tags={"BackendBusPolicies"},
     *   security={{"bearer":{}}},
     ...
     * @OA\Post(
     *   path="/backend/bus_policies",
     *   summary="Create Order Policy",
     *   operationId="createOrderPolicy",
     *   tags={"BackendBusPolicies"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Policy Id", example=1),
     *   @OA\RequestBody(
     *     @OA\JsonContent(
    ...
    /**
     * @OA\Put(
     *   path="/backend/bus_policies/{id}",
     *   summary="Update Order Policy",
     *   operationId="updateOrderPolicy",
     *   tags={"BackendBusPolicies"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Policy Id", example=1),
     *   @OA\RequestBody(
     ...
     * @OA\Patch(
     *   path="/backend/bus_policies/{id}",
     *   summary="Update Order Policy Partial",
     *   operationId="UpdateOrderPolicyPartial",
     *   tags={"BackendBusPolicies"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Policy Id", example="1"),
     *   @OA\RequestBody(
     ...
     * @OA\Delete(
     *   path="/backend/bus_policies/{$id}",
     *   summary="Delete Order Policy",
     *   operationId="deleteOrderPolicy",
     *   tags={"BackendBusPolicies"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Policy Id", example=1),
     *   @OA\Response(response=200, description="Success", @OA\JsonContent()),
    ...
    public function destroy($id) {
        try {
            ...
            /*$find = $this->product_repository->findByAttributes(['policy_id' => $model->id]);
