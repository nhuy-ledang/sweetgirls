 ...
 */
class Import extends CoreModel {
    /**
     * The table associated with the model.
     *
     * @var string
     */
    protected $table = 'bus__imports';
     ...
     * @var array
     */
    protected $fillable = ['product_id', 'idx_im', 'idx', 'idx_shared', 'supplier_id', 'price_im', 'operating_costs', 'expected_profit', 'quantity', 'earning_ratio', 'pretax', 'vat', 'price', 'appraiser_id', 'approver_id', 'approved_at', 'status', 'note'];
    ...
    public function product() {
        return $this->belongsTo('\Modules\Business\Entities\Product', 'product_id', 'id')->withTrashed();
    }
