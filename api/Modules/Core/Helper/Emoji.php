...
/**
 * Class Emoji
 * "phpclasses/emoji-php-static": ">=1.0.0
 */
class Emoji {
    ...
    private static function emoji_docomo_to_unified($text) {
        return self::emoji_convert($text, 'docomo_to_unified');
    }

    private static function emoji_kddi_to_unified($text) {
        return self::emoji_convert($text, 'kddi_to_unified');
    }

    private static function emoji_softbank_to_unified($text) {
        return self::emoji_convert($text, 'softbank_to_unified');
    }

    private static function emoji_google_to_unified($text) {
        return self::emoji_convert($text, 'google_to_unified');
    }

    private static function emoji_unified_to_docomo($text) {
        return self::emoji_convert($text, 'unified_to_docomo');
    }

    private static function emoji_unified_to_kddi($text) {
        return self::emoji_convert($text, 'unified_to_kddi');
    }

    private static function emoji_unified_to_softbank($text) {
        return self::emoji_convert($text, 'unified_to_softbank');
    }

    private static function emoji_unified_to_google($text) {
        return self::emoji_convert($text, 'unified_to_google');
    }

    private static function emoji_unified_to_html($text) {
        return self::emoji_convert($text, 'unified_to_html');
    }

    private static function emoji_html_to_unified($text) {
        return self::emoji_convert($text, 'html_to_unified');
    }

    private static function emoji_unified_to_html2($text) {
        return self::emoji_convert_html($text, 'unified_to_html');
    }

    private static function emoji_html_to_unified2($text) {
        return self::emoji_convert_html($text, 'html_to_unified');
    }

    private static function emoji_unified_to_html_font($text) {
        return self::emoji_convert_font($text, 'unified_to_html_font');
    }

    private static function emoji_html_font_to_unified($text) {
        return self::emoji_convert_font($text, 'html_font_to_unified');
    }
