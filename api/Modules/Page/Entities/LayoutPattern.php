...
class LayoutPattern extends CoreModel {
     ...
     * @var string
     */
    protected $table = 'pg__layout_patterns';
     ...
     * @var array
     */
    protected $fillable = ['module_id', 'code', 'translates', 'name', 'title', 'sub_title', 'short_description', 'description', 'table_contents', 'table_images', 'properties', 'is_overwrite', 'layout', 'tile', 'image', 'attach', 'menu_text', 'btn_text', 'btn_link'];
    ...
    public function descs() {
        return $this->hasMany('\Modules\Page\Entities\LayoutPatternDesc', 'id', 'id');
    }
