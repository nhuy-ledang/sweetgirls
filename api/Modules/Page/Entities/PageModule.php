...
class PageModule extends CoreModel {
     ...
     * @var string
     */
    protected $table = 'pg__page_modules';
     ...
     * @var array
     */
    protected $fillable = ['module_id', 'translates', 'name', 'code', 'position', 'title', 'sub_title', 'short_description', 'description', 'table_contents', 'table_images', 'properties', 'is_overwrite', 'layout', 'tile', 'image', 'attach', 'menu_text', 'btn_text', 'btn_link', 'sort_order', 'status'];
    ...
    public function descs() {
        return $this->hasMany('\Modules\Page\Entities\PageModuleDesc', 'id', 'id');
    }
