 ...
 */
class OrderHistoryController extends ApiBaseModuleController {
    public function __construct(Request $request, OrderHistoryRepository $order_history_repository) {
        $this->model_repository = $order_history_repository;
    ...
    /**
     * @OA\Get(
     *   path="/backend/ord_order_histories",
     *   summary="Get Order Histories",
     *   operationId="getOrderHistories",
     *   tags={"BackendOrderHistories"},
     *   security={{"bearer":{}}},
    ...
    /**
     * @OA\Get(
     *   path="/backend/ord_order_histories/{id}",
     *   summary="Get Order History",
     *   operationId="getOrderHistories",
     *   tags={"BackendOrderHistories"},
     *   security={{"bearer":{}}},
     *   @OA\Parameter(name="id", in="path", description="Order History Id", example=1),
     ...
     *   operationId="createOrderHistories",
     *   tags={"BackendOrderHistories"},
     *   security={{"bearer":{}}},
     *   @OA\RequestBody(
     *     @OA\JsonContent(
