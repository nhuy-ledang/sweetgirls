...
@section('content')
  <tr>
    <td align="center" style="border-collapse: collapse;border-spacing: 0;">
      <table role="presentation" width="800" border="0" cellspacing="0" cellpadding="5" valign="top" style="box-sizing: border-box;padding: 0 25px">
        <tbody>
        <tr>
          <td>
            Thân gửi <strong>{!! $model->first_name !!},</strong>
          </td>
        </tr>
        <tr>
          <td>Đơn hàng <strong>{!! $model->no !!}</strong> đã được {!! $config_owner !!} bàn giao đến đối tác vận chuyển.</td>
        </tr>
        <tr>
          <td> Mã vận đơn: <strong>{!! $viettel_post->order_number !!}</strong></td>
        </tr>
        <tr>
          <td><strong>{!! $model->first_name !!} </strong> có thể tra cứu trạng thái đơn hàng <strong><a href="https://viettelpost.com.vn/tra-cuu-hanh-trinh-don/">tại đây</a></strong></td>
        </tr>
        <tr>
          <td><strong>Lưu ý: </strong>Để đảm bảo quyền lợi của bạn khi mua hàng, vui lòng thực hiện đồng kiểm với nhân viên giao hàng và quay video trong quá trình mở hộp sản phẩm.</td>
        </tr>
      ...
      <table style="width:100%;border-collapse: collapse;border-spacing: 0;margin-bottom: 30px;font-size: 14px;table-layout: fixed;" border="0" valign="top" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td valign="top" style="padding: 0 10px 0 0;">
            <table style="width:100%;border-collapse: collapse;border-spacing: 0;font-size: 14px;" border="0" valign="top" cellspacing="0" cellpadding="0">
              <tbody>
              <tr>
                <td><strong>Thông tin đơn hàng: </strong>{!! $model->no !!}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><strong>Thời gian giao hàng: </strong>Sau 2-5 ngày làm việc</td>
              </tr>
              </tbody>
            </table>
          </td>
        ...
        <tr>
          <td align="center" colspan="2" style="border-collapse: collapse;border-spacing: 0;padding: 15px 0;">
            <a href="https://viettelpost.com.vn/tra-cuu-hanh-trinh-don/" style="display: inline-block;text-align: center; white-space: nowrap;vertical-align: middle;padding: .375rem .75rem;border-radius: 5px;cursor: pointer;background-color: #343a40;color: #fff;border: 1px solid #343a40;text-decoration: none;">THEO DÕI TRẠNG THÁI ĐƠN HÀNG</a>
          </td>
        </tr>
        </tbody>
      </table>
