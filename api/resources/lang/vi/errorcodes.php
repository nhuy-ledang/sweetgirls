...
return [
    ...
    // Auth Exception
    'auth.invalid'                 => [8020, 'Người dùng không hợp lệ.'],
    'auth.invalid_password'        => [8021, 'Mật khẩu không đúng.'],
    'auth.locked'                  => [8022, 'Tài khoản đã bị khóa sau 5 lần thử không thành công.'],
    'auth.inactivate'              => [8023, 'Your account is inactivate'],
    'auth.banned'                  => [8024, 'Tài khoản của bạn đã bị cấm. Vui lòng liên hệ với quản trị viên để khắc phục sự cố.'],
    ...
    'email.unique'                 => [2053, 'Email này đã được sử dụng!'],
    ...
    'password.min'                 => [2061, 'Mật khẩu cần dài ít nhất 8 ký tự.'],
    'password.max'                 => [2062, 'Password must least 255 characters.'],
    'password.regex'               => [2063, 'Mật khẩu phải đáp ứng ít nhất 3 trong 4 tiêu chí: chữ hoa, chữ thường, số, ký tự đặc biệt.'],
    'password.confirmed'           => [2064, 'Mật khẩu mới không khớp.'],
    'password.change_failed'       => [2065, 'Thay đổi mật khẩu không thành công.'],
    'password.old'                 => [2066, 'Mật khẩu không thể sử dụng lại 14 mật khẩu cuối cùng.'],
    'password.invalid'             => [2067, 'Mật khẩu không hợp lệ.'],
    'password.current_failed'      => [2068, 'Mật khẩu hiện tại không khớp.'],
    ...
    'phone_number.invalid'         => [2086, 'Số điện thoại không hợp lệ.'],
    ...
    'shipping_country_id.required' => [2120, 'Quốc gia vận chuyển là bắt buộc.'],
    'shipping_country_id.invalid'  => [2122, 'Quốc gia vận chuyển không hợp lệ'],
    ...
    'coupon.product.invalid'       => [2252, 'Sản phẩm không áp dụng đươc mã giảm giá'],
    ...
    'voucher_code.invalid'         => [2252, 'Mã voucher không có giá trị'],
    ...
    // Validation balance for “Agent Withdrawal”
    'withdrawal.balance.invalid'   => [2252, 'Cộng tác viên chưa phát sinh hoa hồng'],
    // Stock
    'stock.in_stock.same'          => [2900, 'Nơi xuất đến và nơi nhập kho giống nhau'],
    'stock.product.not_enough'     => [2900, 'Sản phẩm không đủ trong kho'],
];
