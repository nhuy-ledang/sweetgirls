...
import { RanksFormComponent } from './form/form.component';
import { UserRanksRepository } from '../shared/services';

@Component({
  selector: 'ngx-user-ranks',
  templateUrl: './ranks.component.html',
})
export class RanksComponent extends AppList implements OnInit, OnDestroy, AfterViewInit {
  @ViewChild(ConfirmComponent) confirm: ConfirmComponent;
  @ViewChild(RanksFormComponent) form: RanksFormComponent;

  constructor(router: Router, security: Security, state: GlobalState, repository: UserRanksRepository) {
