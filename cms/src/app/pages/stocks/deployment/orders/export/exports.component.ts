...
@Component({
  selector: 'ngx-sto-dep-orders-exports',
  templateUrl: './exports.component.html',
})
export class DepOrdersExportsComponent extends AppList implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(router: Router, security: Security, state: GlobalState, repository: OutRequestsRepository, protected _cookie: CookieVar) {
    super(router, security, state, repository);
  }

  ngOnInit(): void {
    this.columnInt(this._cookie, 'sto_dep_orders_export');
