...
import { ExpTicketFormComponent } from './form/form.component';
import { STO_OUT_TYPES, STO_TICKET_STATUSES } from '../../../../app.constants';

@Component({
  selector: 'ngx-sto-exp-tickets',
  templateUrl: './tickets.component.html',
})
export class ExpTicketsComponent extends AppList implements OnInit, OnDestroy, AfterViewInit {
  @ViewChild(ConfirmComponent) confirm: ConfirmComponent;
  @ViewChild(ExpTicketFormComponent) form: ExpTicketFormComponent;
  ...
  columnList = [
    ...
    {id: 'usr_request', name: 'Người yêu cầu', checkbox: true, disabled: false},
    ...
    {id: 'reason', name: 'Lý do xuất', checkbox: true, disabled: false},
    {id: 'staff', name: 'Người nhận giao hàng', checkbox: true, disabled: false},
  ...
  stoOutTypeStatusList: any[] = STO_OUT_TYPES;
  ...
  ngOnInit(): void {
    this.columnInt(this._cookie, 'sto_exp_tickets');
    this.data.data = {q: '', tic_type: 'request', embed: 'request,usr'};
  }
