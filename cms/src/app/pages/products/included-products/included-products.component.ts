...
import { IncludedProductFormComponent } from './form/form.component';

@Component({
  selector: 'ngx-pd-included-products',
  templateUrl: './included-products.component.html',
})
export class IncludedProductsComponent extends AppList implements OnInit, OnDestroy, AfterViewInit {
  @ViewChild(ConfirmComponent) confirm: ConfirmComponent;
  @ViewChild(IncludedProductFormComponent) form: IncludedProductFormComponent;
  ...
  constructor(router: Router, security: Security, state: GlobalState, repository: IncludedProductsRepository, cookie: CookieVar,
              private _categories: CategoriesRepository, private _dialog: Dialog) {
    super(router, security, state, repository);
    this.columnInt(cookie, 'pd_included_products');
