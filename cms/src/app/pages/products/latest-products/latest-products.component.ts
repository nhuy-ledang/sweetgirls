...
import { ProductLatestRepository } from '../services';
import { LatestProductFormComponent } from './form/form.component';

@Component({
  selector: 'ngx-pd-latest-products',
  templateUrl: './latest-products.component.html',
})
export class LatestProductsComponent extends AppList implements OnInit, OnDestroy, AfterViewInit {
  @ViewChild(ConfirmComponent) confirm: ConfirmComponent;
  @ViewChild(LatestProductFormComponent) form: LatestProductFormComponent;
  repository: ProductLatestRepository;

  constructor(router: Router, security: Security, state: GlobalState, repository: ProductLatestRepository) {
