...
@Component({
  selector: 'ngx-pd-gift-product-desc',
  templateUrl: './desc.component.html',
})
export class GiftProductDescComponent extends AppForm implements OnInit, OnDestroy {
  ...
  constructor(fb: FormBuilder, router: Router, security: Security, state: GlobalState, repository: GiftProductsRepository) {
