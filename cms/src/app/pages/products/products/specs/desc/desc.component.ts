...
@Component({
  selector: 'ngx-pd-product-spec-desc',
  templateUrl: './desc.component.html',
})

export class ProductSpecDescComponent extends AppForm implements OnInit, OnDestroy {
  ...
  constructor(fb: FormBuilder, router: Router, security: Security, state: GlobalState, repository: ProductSpecsRepository) {
