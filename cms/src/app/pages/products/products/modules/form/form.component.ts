...
import { DlgCategorySelectComponent } from '../../../../pages/shared/modals';

@Component({
  selector: 'ngx-pd-module-form',
  templateUrl: './form.component.html',
})

export class ProductModuleFormComponent extends BaseModuleFormComponent implements OnInit, OnDestroy {
  ...
  constructor(fb: FormBuilder, router: Router, security: Security, state: GlobalState, repository: ProductModulesRepository, languages: LanguagesRepository,
