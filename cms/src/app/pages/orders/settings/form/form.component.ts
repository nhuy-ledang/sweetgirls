...
@Component({
  selector: 'ngx-ord-setting-form',
  templateUrl: './form.component.html',
})
export class OrderSettingFormComponent extends AppForm implements OnInit, OnDestroy {
  @ViewChild('modal', {static: true}) modal: ModalDirective;
  @Output() onSuccess: EventEmitter<any> = new EventEmitter<any>();
  info: {key: string, value: any, name: string, type: 'default'|'default_textarea'|'number'|'editor_lang'|'text'|'textarea'|'image'|'boolean', thumb_url?: string, note?: string} = {key: '', value: '', name: '', type: 'default'};
  name: any = '';
  value: any;
  ...
  show(info: {key: string, value: any, name: string, type: 'default'|'default_textarea'|'number'|'editor_lang'|'text'|'textarea'|'image'|'boolean', thumb_url?: string}): void {
