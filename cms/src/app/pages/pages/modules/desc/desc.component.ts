...
import { BaseModuleDescComponent } from './base.desc.component';

@Component({
  selector: 'ngx-pg-module-desc',
  templateUrl: './desc.component.html',
})

export class ModuleDescComponent extends BaseModuleDescComponent implements OnInit, OnDestroy {
  ...
  constructor(fb: FormBuilder, router: Router, security: Security, state: GlobalState, repository: ModulesRepository) {
