...
import { ModulesRepository } from '../services';

@Component({
  selector: 'ngx-dlg-module-select',
  templateUrl: './dlg-module-select.component.html',
})

export class DlgModuleSelectComponent extends AppList implements OnInit, OnDestroy {
  ...
  constructor(router: Router, security: Security, state: GlobalState, repository: ModulesRepository, private _dialog: Dialog) {
