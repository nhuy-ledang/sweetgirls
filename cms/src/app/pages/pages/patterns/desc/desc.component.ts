...
@Component({
  selector: 'ngx-pg-pattern-desc',
  templateUrl: '../../modules/desc/desc.component.html',
})

export class PatternDescComponent extends BaseModuleDescComponent implements OnInit, OnDestroy {
  ...
  constructor(fb: FormBuilder, router: Router, security: Security, state: GlobalState, repository: LayoutPatternsRepository) {
