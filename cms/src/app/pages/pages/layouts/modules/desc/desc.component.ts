...
@Component({
  selector: 'ngx-pg-ly-module-desc',
  templateUrl: '../../../modules/desc/desc.component.html',
})

export class LayoutModuleDescComponent extends BaseModuleDescComponent implements OnInit, OnDestroy {
  ...
  constructor(fb: FormBuilder, router: Router, security: Security, state: GlobalState, repository: LayoutModulesRepository) {
