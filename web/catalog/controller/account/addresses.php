<?php
class ControllerAccountAddresses extends Controller {
    public function index() {
        ...
        $this->load->language('account/delivery_address');
        ...
        $data['breadcrumbs'][] = ['text' => $this->language->get('text_delivery_address'), 'href' => ''];
        ...
        $this->response->setOutput($this->load->view('account/addresses', $data));
    }
}
