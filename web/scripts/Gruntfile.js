module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    clean: {
      options: {force: true},
      folders: ['<%= build_dir %>', '<%= compile_dir %>', '<%= release_dir %>/assets']
    },
  ...
  grunt.registerTask( 'compile', [
    /*'less:compile', */'sass:compile', 'copy:compile_assets', 'ngAnnotate', 'concat:compile_js', 'uglify', 'index:compile', 'copy:release_assets'
  ]);
  ...
  grunt.registerMultiTask('index', 'Process index.html template', function() {
    ...
    grunt.file.copy('src/index.html', this.data.dir + '/index.html', {
      process: function(contents, path) {
        return grunt.template.process(contents, {
          data: {
            path: grunt.cli.tasks == 'compile' ? grunt.config('release_dir').replace('../', '/') : grunt.config('build_dir').replace('../', '/'),
            scripts: jsFiles,
            styles: cssFiles,
    ...
    grunt.file.copy(this.data.dir + '/index.html', grunt.config('index_file'));
  });
};
