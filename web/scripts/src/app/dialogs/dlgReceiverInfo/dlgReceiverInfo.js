angular.module('app.dlgReceiverInfo', [])

.controller('DlgReceiverInfoCtrl', function($scope, $rootScope, $uibModalInstance, utils, locations, users, addresses, $data) {
  var vm = this;
  ...
  $scope.submit = function(form) {
    ...
    if (form.$valid) {
      ...
      if(!$scope.info) {
        addresses.createAddress($scope.params).then(function(res) {
...
.factory('dlgReceiverInfo', function($uibModal, helper) {
  return {
    show: function(fn, data) {
      return $uibModal.open({
        animation: true,
        //backdrop: 'static',
        templateUrl: 'dialogs/dlgReceiverInfo/dlgReceiverInfo.tpl.html',
        controller: 'DlgReceiverInfoCtrl',
        controllerAs: 'vm',
        size: 'modal-edit-receiver-info modal-dialog-centered',
        resolve: {
          $data: function() {
            return data;
          }
